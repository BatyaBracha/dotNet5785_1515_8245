...
public enum VolunteerFields { CallInProgress, CallsChosenOutOfdate, CallsDeleted, CallsDone, TypeOfDistance, MaxDistance, Active, Role, 
     Latitude, CurrentAddress, Password, Email, PhoneNumber, Name, Id }
